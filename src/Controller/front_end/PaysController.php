...
class PaysController extends AbstractController
{
    ...
    {
        return $this->render('front_end/pays/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('front_end/pays/new.html.twig', [
            'pay' => $pay,
    ...
    {
        return $this->render('front_end/pays/show.html.twig', [
            'pay' => $pay,
        ]);
    }
    ...
    public function edit(Request $request, Pays $pay, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('front_end/pays/edit.html.twig', [
            'pay' => $pay,
            'form' => $form->createView(),
        ]);
    }
